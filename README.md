...
Configured for **Vercel** (same as production). Set environment variables from `.env.example` in the Vercel project settings.

## Contact

- [LinkedIn](https://www.linkedin.com/in/siegfriedbozza)  
- Email: see About page or `NEXT_PUBLIC_MAIL_TO` in `.env.local`  
