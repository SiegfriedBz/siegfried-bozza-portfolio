  ...
  const { live, github, ...rest } = props 
    ...
    <ButtonGroup {...rest}>
      <Button asChild variant={"outline"}>	
        <a href={github} target="_blank" rel="noopener noreferrer" className="group flex items-center gap-x-2">
      ...
      <Button asChild variant={"outline"}>
        <a href={live} target="_blank" rel="noopener noreferrer" className="group flex items-center gap-x-2">
					<span className="text-accent-blue group-hover:text-accent-foreground dark:group-hover:text-white transition-colors duration-200">
            <span className="max-[380px]:hidden">View </span> 
